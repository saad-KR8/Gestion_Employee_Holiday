...
public class HolidayView extends JFrame {
    ...
    private JComboBox<T_Holiday> typeComboBox = new JComboBox<>(T_Holiday.values());
    private JLabel dateDebutLabel = new JLabel("Date de début");
    private JTextField dateDebutField = new JTextField("YYYY-MM-DD");
    private JLabel dateFinLabel = new JLabel("Date de fin");
    private JTextField dateFinField = new JTextField("YYYY-MM-DD");
    private DefaultTableModel tableModel = new DefaultTableModel(new String[]{"Id","Employé","Type","Date début","Date fin"}, 0);
    private JTable holidayTable = new JTable(tableModel);
    ...
    public HolidayView() {
        ...
        inputPanel.add(dateDebutField);
        inputPanel.add(dateFinLabel);
        inputPanel.add(dateFinField);
    ...
    public JComboBox<T_Holiday> getTypeComboBox() {
        return typeComboBox;
    }
